...
export class Menu{
    game
    offset=0
    options = [new Setting("Theme","options","null",["Classic","Original"]),new Setting("Pixel Perfect?","boolean",true,[false,true],1),new Setting("option 3"),new Setting("Clear Save?","boolean",false,[false,true],0)]
    selected = 0
    selectedSmooth=0
    settingState=0
