...
export class Menu{
    game
    offset=0
    options = [new Setting("Theme","options","classic",["classic","retro","gameboy"]),new Setting("option 2"),new Setting("option 3"),new Setting("option 4","boolean",true,[false,true],1)]
    selected = 0
    selectedSmooth=0
    constructor(game){
        this.game = game
