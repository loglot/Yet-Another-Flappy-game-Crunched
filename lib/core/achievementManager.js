...
export class Achievement {
    ...
    unlocked=[]
    rewards=[
        new Theme("Retro","Unlocked Retro Theme",["#ffffff","#000000","#000000","#000000","#000000"],"this.game.player.score == 20"),
        new Theme("Test","Unlocked Test Theme",["#b7cdcfff","#3a3a3a","#ffb4b4","#64a194","#be6d6d5e"],"this.game.player.score == 1"),
        new Theme("Original [for reference]","",["#33363f","#a7c7d8","#ffffff","#afbfaf","#00000050"],"false")
    ]
    constructor(game){
        this.game = game
    }
    tick(){
        for(let i = 0; i<this.rewards.length;i++){
            if(!this.unlocked[i]&&eval(this.rewards[i].prerequisate)){
