...
export class Achievement {
    ...
    unlocked=[]
    rewards=[
        new Theme("Space","Unlocked Space Theme",["#aaaaaa","#052030","#ffffff",["#afbfaf", "#c0b090", "#bfafbf", "#bfcfaf", "#dfafaf", "#ddd"],"#aaaaaa50","#53565f","#fff5","#dfdf8d"],"this.game.spacecount == 10"),
        new Theme("Retro","Unlocked Retro Theme",["#ffffff","#000000","#000000",["#000000","#555","#888","#bbb"],"#000000","#ffffff","#fff","#000000"],"this.game.player.score == 20"),
        new Theme("GameBoy","Unlocked Gameboy Theme",["#333030","#88985b","#d8ceae",["#667f59","#88985b","#b3b37e"],"#00000050","#333030","#88985b","#d8ceae"],"false"),
        new Theme("Test","Unlocked Test Theme",["#b7cdcf","#3a3a3a","#ffb4b4",["#64a194"],"#be6d6d5e","#b7cdcf","#fff5","#522df5ff"],"false"),
        new Theme("[null]","Unlocked [null] Theme",["#000000","#000","#000",["#000"],"#000","#000","#000","#000"],"false"),
