...
export class Achievement {
    ...
    unlocked=[]
    rewards=[
        new Theme("Space Game","Unlocked Space Theme",["#aaaaaa","#052030","#ffffff","#afbfaf","#aaaaaa50","#53565f","#fff5"],"this.game.spacecount == 10"),
        new Theme("Retro","Unlocked Retro Theme",["#ffffff","#000000","#000000","#000000","#000000","#ffffff","#fff"],"this.game.player.score == 20"),
        new Theme("GameBoy","Unlocked Gameboy Theme",["#333030","#88985b","#d8ceae","#667f59","#00000050","#333030","#88985b"],"false"),
        new Theme("Test","Unlocked Test Theme",["#b7cdcf","#3a3a3a","#ffb4b4","#64a194","#be6d6d5e","#b7cdcf","#fff5"],"false"),
        new Theme("Classic","Unlocked Classic Theme?",["#33363f","#a7c7d8","#ffffff","#afbfaf","#00000050","#33363f","#fff5"],"false")
    ]
    constructor(game){
        this.game = game
    }
