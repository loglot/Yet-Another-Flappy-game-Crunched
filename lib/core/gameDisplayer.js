...
export class Display{
    ...
    drawSmooth(){
        ...
        // ctx.lineJoin = 'miter';
        // ctx.miterLimit = 3
        // ctx.strokeText("Yet Another Flappy Game", 10*scale/10, 20*scale/10)
        // ctx.strokeText("Press W To Start", 10*scale/10, 45*scale/10)
        // ctx.fillStyle = "#fff"
        // ctx.fillText("Press W To Start", 10*scale/10, 45*scale/10)
        // ctx.fillText("Yet Another Flappy Game", 10*scale/10, 20*scale/10)
