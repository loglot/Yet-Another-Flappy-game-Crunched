...
export class Display{
    ...
    drawSmooth(anim){
        ...
        ctx.textBaseline = 'middle';
            ...
            ctx.lineJoin = 'miter';
            ctx.miterLimit = 3
        ctx.translate(this.game.displayinfo.aspectRatio[0]/2,this.game.displayinfo.aspectRatio[1]+300+anim)
        ctx.beginPath()
        ctx.fillStyle = "#00000050"
        ctx.arc(0,0,650,0,100,false)
        ctx.fill()
        ctx.fillStyle = "#ffffffff"
            ctx.strokeText("Press S For Settings",0,-400)
            ctx.fillText("Press S For Settings",0,-400)
        ctx.textAlign = "left"
