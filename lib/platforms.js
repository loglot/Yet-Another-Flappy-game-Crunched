...
export class Platforms{
    ...
    tick(){
        for(let i = 0; i<this.platform.length; i++){
            ...
            if(this.platform[i].hitTimer < 0&&this.game.player.colide){
                ...
                if(
                    ...
                    if(this.game.player.jumps<this.game.player.maxJumps){
                        this.game.player.jumps=this.game.player.maxJumps
                    }
    ...
    reset(){
        this.platform = [new Entity(2,80,0,-.2)]
    }
    draw(actx){
        for(let i = 0; i<this.platform.length; i++){
