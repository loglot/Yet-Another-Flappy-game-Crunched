export class Player{
    x; y; velX; velY; targetX; jumps; scoreTimer; score; money
    game
    constructor(
        Game,
        x = 192/2, 
    ...
    this.x = x; this.y = y; this.velX=velX; this.velY=velY; this.targetX = targetX; this.jumps=jumps; this.scoreTimer =scoreTimer; this.score=score; this.money=money
        this.game = Game
    }
    reset(){
