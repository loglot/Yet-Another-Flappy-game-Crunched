...
export class Game{
    ...
    tick(){
        ...
        if(this.state==1){
            ...
            this.anim[1] = ((this.anim[1]*9))/10
            this.anim[2] = ((this.anim[2]*9))/10
            if(this.justPressed(kd.E)){
                this.state=1.1
            }
            ...
            this.display.drawGame()
            this.anim[1] = ((this.anim[1]*9))/10
            this.anim[2] = ((this.anim[2]*9)+350)/10

        } else if(this.state==0){
            this.anim[1] = ((this.anim[1]*9))/10
            this.anim[0] = ((this.anim[0]*9))/10
    ...
    init(){
        if(JSON.parse(this.cookies.get("options"))[3]==true){
            this.clearCookies()
        }
    ...
    clearCookies(){
            this.cookies.clear("themes")
            this.cookies.clear("HS")
